...
<div class="top_panel_navi sc_layouts_row sc_layouts_row_type_compact sc_layouts_row_fixed
			scheme_<?php echo esc_attr(green_planet_is_inherit(green_planet_get_theme_option('menu_scheme')) 
		...
		<div class="columns_wrap">
			...
			?><div class="sc_layouts_column sc_layouts_column_align_right sc_layouts_column_icons_position_left column-3_4">
				<div class="sc_layouts_item">
					<?php
					// Main menu
					$green_planet_menu_main = green_planet_get_nav_menu(array(
						'location' => 'menu_main', 
						'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile'
						)
					);
					if (empty($green_planet_menu_main)) {
						$green_planet_menu_main = green_planet_get_nav_menu(array(
							'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile'
							)
						);
					}
					green_planet_show_layout($green_planet_menu_main);
					// Mobile menu button
					?>
				...
				<div class="sc_layouts_item">
					...
					do_action('green_planet_action_search', 'fullscreen', 'header_search', false);
					?>
				</div>			
			</div>
		</div><!-- /.sc_layouts_row -->
