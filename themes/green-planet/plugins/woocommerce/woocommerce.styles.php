...
if ( !function_exists( 'green_planet_woocommerce_get_css' ) ) {
	add_filter( 'green_planet_filter_get_css', 'green_planet_woocommerce_get_css', 10, 4 );
	function green_planet_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.green_planet_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.green_planet_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
