...
trx_addons_exists_trx_donations();
		...
		return apply_filters('trx_addons_sc_map', array(
				...
				"params" => array_merge(
					array(
						...
						array(
							"param_name" => "style",
							"heading" => esc_html__("Style of list", 'trx_addons'),
							"description" => wp_kses_data( __("Donations category", 'trx_addons') ),
							"value" => array(
										esc_html__("Excerpt column style", 'trx_addons') => 'excerpt',
										esc_html__("Row style", 'trx_addons') => 'row',
										esc_html__("Simple style", 'trx_addons') => 'simple'
								),
							"std" => "",
							"type" => "dropdown"
						)
